...
const Spotify = {
        ...
        savePlaylist(playListName, tracksURIsArray) {
            if (!playListName || !tracksURIsArray.length) {
                return;
            }
            ...
            let urlToFetch = spotifyRequestURI + "me";
            return fetch(urlToFetch, {
                headers: header
            }).then(response => {
                return response.json();
                    ...
                    return fetch(urlToFetch, {
                        ...
                        return fetch(urlToFetch, {
                            headers: header,
                            method: 'POST',
                            body: JSON.stringify({uris: tracksURIsArray}),
                        })
                    })
                }
            )
